...
class GrievanceForm(models.Model):
    ...
    assign_to_users = fields.Many2many('res.users', string='Assigned To Users', related='type_of_issue.assigned_to_users')
    state = fields.Selection([('draft', 'Draft'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], string='State', default='draft')
